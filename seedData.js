...
for (let newUser of users) {
    for (let i = 0; i < 6; i++) {
        ...
        let course = new Course({name: courseNames[randomIndex], bgImgUrl: imgUrls[randomIndex], description: "Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.", students: [newUser._id]});
